...
<tr>
	...
	<td><input type="text" name="first_name" id="first_name" value="asdf" class="regular-text"></td>
</tr>

<tr>
	<th><label for="last_name">Last Name</label></th>
	<td><input type="text" name="last_name" id="last_name" value="adsfas" class="regular-text"></td>
</tr>
</tbody></table>
