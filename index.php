...
Plugin URI: http://hiteshjoshi.com/wordpress/plugins/real-estate-client-monitor
Description: The Plugin is designed to help realators to monitor client's and their document's.<br/>Full detail of this plugin is available at http://hiteshjoshi.com/wordpress/plugins/real-estate-client-monitor
Version: 1.8
Author: Hitesh Joshi
...
CREATE TABLE IF NOT EXISTS `".$wpdb->prefix."rep_mortgage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `borrower` varchar(255) NOT NULL,
  `phone` varchar(255) NOT NULL,
  `last_4_of_social` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `property_address` tinytext NOT NULL,
  `street_name` varchar(255) NOT NULL,
  `mailing_address` tinytext NOT NULL,
  `buyers_agent` varchar(255) NOT NULL,
  `phone_no` tinytext NOT NULL,
  `buyer` varchar(255) NOT NULL,
  `purchase_price` varchar(255) NOT NULL,
  `buyer_agent` varchar(255) NOT NULL,
  `seller_email` varchar(255) NOT NULL,
  `buyer2` varchar(255) NOT NULL,
  `escrow_officer` varchar(255) NOT NULL,
  `buyers_lender` varchar(255) NOT NULL,
  `nemail1` varchar(255) NOT NULL,
  `nemail2` varchar(255) NOT NULL,
  `nemail3` varchar(255) NOT NULL,
...
if(content_html=='') {
$('div#file').html('<h2>Sorry No File Found!</h2>'); }
...
$content .= "<option value=$l_year >$l_year</option>"; }
$content .= '</select>';
if($show_yearly){
...
$text = str_replace('[RealEstatePropertyMonitor]',$content,$text);
...
$text = str_replace('[RealEstatePropertyMonitor]', $login_form,$text);
return $text;
		}
